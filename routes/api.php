...
Route::delete('/business/profileLogo/logoDel/{business_id}',[App\Http\Controllers\Api\BusinessLogoController::class, 'logoDel']);
Route::delete('/business/profileLogo/profilePicDel/{business_id}',[App\Http\Controllers\Api\BusinessLogoController::class, 'profilePicDel']);
 
Route::post('/business/save-gallery',[App\Http\Controllers\Api\BusinessLogoController::class,'saveGallery']); 
Route::post('/business/save-pictures',[App\Http\Controllers\Api\BusinessLogoController::class,'savePictures']); 

Route::post('/business/save-certificate',[App\Http\Controllers\Api\BusinessLogoController::class, 'saveBusinessCertificate']); 
Route::post('/business/save-award',[App\Http\Controllers\Api\BusinessLogoController::class, 'saveBusinessAward']); 



Route::middleware('auth:sanctum')->group(function () {

Route::post('/client/push-lead', [EnquiryController::class, 'clientPushLead']);

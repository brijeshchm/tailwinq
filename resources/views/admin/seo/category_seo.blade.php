<?php echo View::make('admin/header'); ?>
 ...
 @if(Request::segment(2)=='categoryEdit'  && Request::segment(1)=='developer'  )
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Update SEO Fields - {{$keyword->parent_category}}</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
			  <style>
...
padding:0px;
                ...
                <div class="col-lg-12">			
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							<form class="form-horizontal" role="form" method="POST" action="{{ url('/developer/updateCategorySEO/seo/'.$keyword->id) }}">
								{{ csrf_field() }}
            ...
            <h4>About Category Content</h4>
            <form class="form-horizontal" method="POST" onsubmit="return CategoryController.updateAboutCategory(this,<?php echo (isset($keyword->id)? $keyword->id:""); ?>)" >
                {{ csrf_field() }}
...
@else
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">				
                    <h1 class="page-header">Category For SEO</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table id="datatable-category-seo" class="table table-bordered table-hover">
									<thead>
										<tr>
											<th>Category</th>
											<th>Meta Title</th>

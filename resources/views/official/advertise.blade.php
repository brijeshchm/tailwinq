...
<div class="about-bg page-hearder-area">
  ...
  </div>   <div id="about" class="about-area area-padding">
    <div class="container">
      
      <div class="row">
       <div class="aboutus">
		<div class="container">
			<h3>About Us Our company information</h3>
			<hr>
			<div class="col-md-7">
            ...
            <div class="single-well">             
              ...
              <ul>
                <li>
                  <i class="fa fa-check"></i> Graphic Design
                </li>
                <li>
                ...
                <li>
                  <i class="fa fa-check"></i> PHP Mysql
                </li>
              </ul>
            </div>
          </div>

            ...
            <nav class="navbar navbar-default">
              ...
              <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll sticky-logo" href="{{url('')}}">
                  <h1><img loading="lazy" src="{{ asset('/public/client/images/logo.png') }}" style="width: 183px;margin-top: -27px; border: none;border-radius: 50px;" ><!--<div class="logo-text">Quick Dials</div>--></h1>
              ...
              <div class="collapse navbar-collapse main-menu bs-example-navbar-collapse-1" id="navbar-example">
				...
				<li class="<?php if(Request::segment(1) && Request::segment(1)=='careers'){ echo "active"; } ?>">
				  ...
				  <li class="<?php if(Request::segment(1) && Request::segment(1)=='pricing'){ echo "active"; } ?>">
                    <a class="page-scroll" href="{{route('pricing')}}">Pricing</a>
                  </li>
                  <li class="<?php if(Request::segment(1) && Request::segment(1)=='contact-us'){ echo "active"; } ?>">
                    <a class="page-scroll" href="{{ route('contact.us') }}">Contact Us</a>
                  </li>
...
<li><a href="{{ route('pricing') }}" title="pricing">Packege Pricing</a></li>
<li><a href="{{ route('careers') }}" title="Careers">Careers</a></li>


<li><a href="{{ route('contact.us') }}" title="Contact Us">Contact Us</a></li>
<li><a href="{{ route('blog.show') }}" title="Blog">Blog</a></li> 
<li><a href="{{url('business-owners')}}" rel="nofollow" title="Advertise on Quick Dials">Advertise on Quick Dials</a></li>
<li><a href="{{route('terms.conditions')}}" title="Terms & Conditions">Terms & Conditions</a></li>
<li><a href="{{route('privacy.policy')}}" title="Privacy Policy">Privacy Policy</a></li>
<li><a href="{{route('copyright.policy')}}" title="Copyright Policy">Copyright Policy</a></li>
</ul>
